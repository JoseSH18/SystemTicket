...
const FormEditTicket = () => {
  ...
  const update = async (e) => {
    ...
    ids_Categories.forEach((categoryId) =>
      formData.append('ids_Categories[]', categoryId)
    );
    ...
    await axios
      .post(`${endpoint}/ticket/update/${id}`, formData, {
        headers: {
    ...
    <div>
      ...
      <Form onSubmit={update}>
        <Form.Group controlId="formText">
          ...
          />
          {errors.title && (
            <span className="error text-danger">{errors.title[0]}</span>
          )}
        </Form.Group>
        ...
        <Form.Group controlId="formPriority">
          ...
          <Form.Control
            as="select"
            value={id_Priority}
            onChange={(e) => setId_Priority(e.target.value)}
            required
          >
            ...
            {errors.id_Priority && (
              <span className="error text-danger">{errors.id_Priority[0]}</span>
            )}
          </Form.Control>
        </Form.Group>
        ...
        <Form.Group controlId="formStatus">
          ...
          >
            ...
            {errors.id_Status && (
              <span className="error text-danger">{errors.id_Status[0]}</span>
            )}
          </Form.Control>
        </Form.Group>
        ...
        <Form.Group controlId="formDescription">
          ...
          <Form.Control
            ...
            required
          />
          {errors.text_Description && (
            <span className="error text-danger">
              {errors.text_Description[0]}
            </span>
          )}
        </Form.Group>
        ...
        <Form.Group controlId="formCategory">
          ...
          >
            ...
            {errors.ids_Categories && (
              <span className="error text-danger">
                {errors.ids_Categories[0]}
              </span>
            )}
          </Form.Control>
        </Form.Group>
        ...
        <Form.Group controlId="formTag">
          ...
          >
            ...
            {errors.ids_Tags && (
              <span className="error text-danger">{errors.ids_Tags[0]}</span>
            )}
          </Form.Control>
        </Form.Group>
        ...
        {role === 'admin' && (
          <Form.Group controlId="formAgent">
            ...
            >
              ...
              {errors.id_Agent && (
                <span className="error text-danger">{errors.id_Agent[0]}</span>
              )}
            </Form.Control>
          </Form.Group>
        )}
